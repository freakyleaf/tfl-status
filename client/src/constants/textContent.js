export const contentBackToBus = 'all bus services';
export const contentBackToCore = 'all core services';
export const contentBackToNationalRail = 'all national rail services';
